...
Analysis_run = "Tissue_v1_subtype_tumour"
...
Run_Interactive = F # Launch the shiny dashboard

# Analysis settings -------------------------------------------------------

# Group setup
Treatment_group = "LUAD"
Reference_group = "SCC"
...
Sample_data_path = "./Data/Sample Metadata/Tissue_sample_data_subtype_tumor.xlsx"
